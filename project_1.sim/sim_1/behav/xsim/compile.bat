...
REM
REM Generated by Vivado on Fri Apr 24 18:41:56 +0530 2026
...
echo "xvlog --incr --relax -prj mehak_testbench_vlog.prj"
call xvlog  --incr --relax -prj mehak_testbench_vlog.prj -log xvlog.log
