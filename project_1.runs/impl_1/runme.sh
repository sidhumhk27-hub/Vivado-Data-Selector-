...
HD_PWD='C:/Users/mehak/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mehak_behaviour.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mehak_behaviour.tcl -notrace
