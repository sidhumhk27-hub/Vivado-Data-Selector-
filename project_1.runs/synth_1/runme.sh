...
HD_PWD='C:/Users/mehak/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mehak_behaviour.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mehak_behaviour.tcl
